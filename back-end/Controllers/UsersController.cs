...
using Stockaccino.Infrastructure;
...
public class UsersController : ControllerBase
{
    ...
    public UsersController(UsersService usersService, IJwtAuthManager jwtAuthManager)
    {
...
// Le code suivant est une copie d'un controlleur qui utilise les services JWT. On peut s'y référer.
